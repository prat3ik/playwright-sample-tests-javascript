...
- Name: bulk-tc.spec.js >> Flaky suite >> FLAKY-2: intermittent assertion (fails ~40% of runs)
- Location: tests/bulk-tc.spec.js:28:9

# Error details

```
Error: Simulated flake: random draw fell below 0.4

expect(received).toBeGreaterThan(expected)

Expected: > 0.4
Received:   0.29898261773721124
```
...
- generic [active]:
  - generic:
    - main:
      ...
      - paragraph [ref=e3]:
        - code [ref=e5]: bom1::ktf56-1784808215648-c677fbad0a1f
```
