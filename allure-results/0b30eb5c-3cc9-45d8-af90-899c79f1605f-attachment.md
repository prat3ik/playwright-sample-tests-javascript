...
- Name: bulk-tc.spec.js >> Bulk storefront checks >> TC-5: Verify storefront loads and title is correct
- Location: tests/bulk-tc.spec.js:13:9
...
- generic [active]:
  - generic:
    - main:
      ...
      - paragraph [ref=e3]:
        - code [ref=e5]: bom1::bcz9h-1784808204205-7d0b74c387c9
```
