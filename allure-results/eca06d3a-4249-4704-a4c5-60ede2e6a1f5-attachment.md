...
- Name: bulk-tc.spec.js >> Flaky suite >> FLAKY-6: simulated slow dependency (1-3s) against a 2s budget
- Location: tests/bulk-tc.spec.js:35:7

# Error details

```
Error: Simulated slow dependency exceeded 2s budget
...
- generic [active]:
  - generic:
    - main:
      ...
      - paragraph [ref=e3]:
        - code [ref=e5]: bom1::qgt9q-1784808216828-9b439ba30fd6
```
