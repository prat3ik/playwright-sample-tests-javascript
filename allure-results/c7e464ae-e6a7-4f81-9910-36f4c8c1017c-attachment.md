...
- Name: bulk-tc.spec.js >> Flaky suite >> FLAKY-3: intermittent assertion (fails ~50% of runs)
- Location: tests/bulk-tc.spec.js:28:9

# Error details

```
Error: Simulated flake: random draw fell below 0.5

expect(received).toBeGreaterThan(expected)

Expected: > 0.5
Received:   0.32936951708817086
```
...
- generic [active]:
  - generic:
    - main:
      ...
      - paragraph [ref=e3]:
        - code [ref=e5]: bom1::n9mmm-1784808215670-a029c74430e9
```
